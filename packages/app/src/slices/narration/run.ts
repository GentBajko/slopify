...
// and the picked intro and outro are one request each. Every call goes through the wrapped
// `providers.tts`, so the retry policy covers all of them and nothing here waits or counts
// attempts.
