...
describe("resolveTheme", () => {
  it("returns the DiceMaster defaults when given nothing", () => {
  ...
  it("does not change the defaults it merges onto", () => {
    ...
    expect(defaultTheme().endPage.lines).toHaveLength(11);
  });
...
describe("builtInTheme", () => {
  it("makes plain an unbranded flat page on top of the same layout", () => {
