...
import { cliProbeTimeoutMs } from "../src/slices/settings/cli-status.js";
...
// These booted-app checks make two real readiness requests. Allow their documented
// probe budget even when a locally installed CLI starts slowly under the full suite.
const readinessTestTimeoutMs = 2 * cliProbeTimeoutMs + 5000;
...
describe("a provider key on a booted app", () => {
  it(
    "is saved, masked in the answer, and removed again",
    async () => {
