...
All saved prompts, in three kinds: article, image, thumbnail (Q6, Q13).
...
Element tree:
- App shell
  - Kind tabs: Article / Image / Thumbnail (Q6, Q13)
  - New
...
| Label | Does | Leads to |
|---|---|---|
| Article / Image / Thumbnail tabs | Filters the list by prompt kind (Q6, Q13) | Stays |
