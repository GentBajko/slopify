...
Inspected source and test configuration at `89db8f6d89816b7e2457cb8abd6dade8acb42aa5` on 2026-09-13. Test-run evidence below is historical execution evidence with its own source commit; the file inventory is the current checkout.
...
| `packages/app/src/edge` | 2 | `packages/app/src/edge/open-browser.test.ts:1` |
| `packages/app/src/edge/events` | 3 | `packages/app/src/edge/events/hub.test.ts:1` |
| `packages/app/src/edge/http` | 24 | `packages/app/src/edge/http/actions.test.ts:1` |
...
| `packages/app/src/kernel/runner` | 8 | `packages/app/src/kernel/runner/attempt-repo.test.ts:1` |
...
| `packages/app/src/slices/play-drafts` | 11 | `packages/app/src/slices/play-drafts/attachments.test.ts:1` |
...
| `packages/app/src/slices/storage` | 11 | `packages/app/src/slices/storage/asset-name.test.ts:1` |
...
| `packages/app/test` | 22 | `packages/app/test/article-run.test.ts:1` |
| `packages/app/test/e2e` | 4 | `packages/app/test/e2e/editable-projects.test.ts:1` |
...
| `packages/web/src/play` | 29 | `packages/web/src/play/admission.test.ts:1` |
| `packages/web/src/project` | 30 | `packages/web/src/project/api.test.ts:1` |
| `packages/web/src/routes` | 15 | `packages/web/src/routes/entries.test.tsx:1` |
...
```sh
npx vitest run packages/app/src/adapters/ffmpeg.test.ts packages/app/src/main.test.ts packages/app/test/e2e/skeleton.test.ts packages/app/test/e2e/optional-outputs.test.ts packages/app/test/e2e/editable-projects.test.ts packages/app/test/e2e/play-drafts.test.ts packages/app/src/adapters/alignment packages/app/src/slices/fonts packages/app/src/edge/http/fonts.test.ts packages/app/src/slices/subtitles
...
npx vitest run packages/app/src/catalog packages/app/src/kernel/runner/queue.test.ts packages/app/src/slices/batch packages/app/src/slices/narration/plan.test.ts packages/app/src/slices/narration/chunk.test.ts packages/app/src/edge/open-folder.test.ts packages/app/src/edge/http/files.test.ts packages/app/src/slices/video/subtitle-only.test.ts
...
The inventory is broadest by direct test-file count in rebuild (44), project UI (30), Play UI (29), revisions (28), HTTP routes (24), and composed app tests (22). Runner, adapters, storage, admission, settings, updater, and telemetry also have multiple colocated suites. These counts describe test distribution, not measured coverage percentages; no coverage provider/threshold is configured in the root or package Vitest configs. `vitest.config.ts:3` `packages/app/vitest.config.ts:3` `packages/web/vitest.config.ts:5` `packages/collector/vitest.config.ts:3` `packages/site/vitest.config.ts:3`
