...
source: standards-interview.md (Q1-Q10)
---
...
- A licence that charges companies and not individuals: withdrawn; MIT stands (architecture §Q3). The options examined (PolyForm Small Business 1.0.0, BSL 1.1 with an Additional Use Grant, AGPL + commercial) are on record in `standards-interview.md` for a later decision.
